 ...
 */
final class Version20220921102708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fact (id INT AUTO_INCREMENT NOT NULL, security_id INT NOT NULL, attribute_id INT NOT NULL, value FLOAT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
